      ...
      <Card className="bg-primary text-primary-foreground border-0 shadow-lg overflow-hidden relative">
        ...
        <CardContent className="p-5 relative z-10">
          ...
          <div className="flex items-end gap-3 mt-1">
            <p className="text-3xl font-extrabold tracking-tight">7,420 NDC</p>
            <span className="flex items-center gap-0.5 text-xs font-semibold text-accent mb-1">
              <ArrowUpRight className="h-3 w-3" /> +12.4%
            </span>
          </div>
          <p className="text-xs text-primary-foreground/50 mt-1">≈ ₦148,400</p>

          <div className="flex gap-3 mt-4">
            <Button size="sm" className="flex-1 bg-accent text-accent-foreground hover:bg-accent/90 font-bold text-xs h-9 rounded-xl">
              🌱 Sow
            </Button>
            <Button size="sm" variant="outline" className="flex-1 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 font-bold text-xs h-9 rounded-xl">
              🌾 Harvest
            </Button>
          </div>
        </CardContent>
