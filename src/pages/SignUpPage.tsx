            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="lastName" placeholder="Farmer" value={lastName} onChange={e => setLastName(e.target.value)}
                    className="h-12 rounded-2xl bg-muted/50 border-border/60 text-[14px] focus:bg-card" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" type="tel" placeholder="+234 800 000 0000" value={phone} onChange={e => setPhone(e.target.value)}
                  className="h-12 rounded-2xl bg-muted/50 border-border/60 text-[14px] focus:bg-card" />
              </div>
