...
const MarketPage = () => (
  <div className="min-h-screen bg-background pb-20">
    <div className="max-w-md mx-auto px-4 pt-6 space-y-6">
      <h1 className="text-xl font-extrabold text-foreground">Market</h1>

      <div className="flex gap-2">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
          <Input placeholder="Search tokens..." className="pl-9 h-10 rounded-xl" />
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="border shadow-sm">
          <CardContent className="p-3 text-center">
            ...
            <p className="text-lg font-extrabold text-foreground">₦2.4M</p>
            <span className="text-[10px] text-primary font-semibold flex items-center justify-center gap-0.5">
        ...
        <Card className="border shadow-sm">
          <CardContent className="p-3 text-center">
            ...
            <p className="text-lg font-extrabold text-foreground">₦580K</p>
            <span className="text-[10px] text-primary font-semibold flex items-center justify-center gap-0.5">
      ...
      <div className="space-y-2">
        {marketItems.map((m) => (
          <Card key={m.name} className="border shadow-sm">
            <CardContent className="p-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${m.trending ? "bg-primary/10" : "bg-destructive/10"}`}>
              ...
              <div className="text-right">
                <p className="text-xs font-bold text-foreground">{m.price}</p>
